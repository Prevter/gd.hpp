...
namespace gd::sigscan {
    PatternToken parseToken(std::string pattern, uint32_t &currentIndex) {
        PatternToken token;
    ...
    bool eatToken(const char symbol, const std::string &pattern, uint32_t &currentIndex) {
    ...
    int8_t readSignedByte(const std::string &pattern, uint32_t &currentIndex) {
