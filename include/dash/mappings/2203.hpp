...
/// @brief Contains the mappings for version 2.203.
namespace gd::maps::v2_203 {
    inline std::unordered_map<std::string, uintptr_t> addresses = {
            ...
            {"AppDelegate::applicationWillEnterForeground", 0x5B520},
            {"AppDelegate::applicationDidFinishLaunching",  0x5B310},
            {"AppDelegate::applicationDidEnterBackground",  0x5B4E0},
            {"AppDelegate::applicationWillBecomeActive",    0x5B4C0},
            {"AppDelegate::applicationWillResignActive",    0x5B4D0},
            {"AppDelegate::trySaveGame",                    0x5B780},
            ...
            {"GameLevelManager::sharedState",               0xf3a10},
            ...
            {"GJDropDownLayer::showLayer",                  0x1D69F0},

            {"GJBaseGameLayer::init",                       0x190290},
            {"GJBaseGameLayer::update",                     0x1BB620},
            {"GJBaseGameLayer::destroyObject",              0x19CE40},
            {"GJBaseGameLayer::pickupItem",                 0x19CFF0},
            {"GJBaseGameLayer::setStartPosObject",          0x199DA0},
            {"GJBaseGameLayer::resetCamera",                0x1C2140},
            ...
            {"PlayerObject::pushButton",                    0x2D1870},
            {"PlayerObject::releaseButton",                 0x2D1AB0},
            {"PlayerObject::flipGravity",                   0x2D3160},
            ...
            {"PlayLayer::playEndAnimationToPos",            0x2DF830},
            {"PlayLayer::playPlatformerEndAnimationToPos",  0x2E0010},
            {"PlayLayer::getCurrentPercentInt",             0x2E60b0},
